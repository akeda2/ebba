    ...
    match mode {
        ...
        HelpMode::Text => match profile {
            KeybindingProfile::MacOs => vec![
                ...
                item("Toggle BOM", "Ctrl+B", 3),
                item("Tab width", "Ctrl+T", 3),
                item("Hard tabs", "Ctrl+Shift+T/Ctrl+Alt+T/Ctrl+Shift+H/F4", 3),
                item("Toggle wrap", "Ctrl+W", 3),
                item("Toggle invisibles", "Ctrl+K", 3),
            ...
            KeybindingProfile::Linux => vec![
                ...
                item("Toggle BOM", "Ctrl+B/Alt+B/Ctrl+Shift+B", 3),
                item("Tab width", "Ctrl+T", 3),
                item(
                    "Hard tabs",
                ...
                item("Toggle wrap", "Ctrl+W", 3),
                item("Toggle invisibles", "Ctrl+K/Alt+I", 3),
